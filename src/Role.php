...
class Role extends Model
{
    ...
    {
        return $this->belongsToMany(config('nova-permissions.user_model', 'App\Models\User'), config('nova-permissions.table_names.role_user', 'role_user'), 'role_id', config('nova-permissions.column_names.user_id', 'role_user'));
    }
